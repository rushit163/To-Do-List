...
const Todo = ({list,editTask,DeleteTask,editTodo}) => {
  ...
  return (
    <div key={list.id} className='grid grid-cols-9 text-white my-3 mx-2'>
        ...
        <div className='col-span-1'><button className='bg-blue-500 hover:bg-blue-700 text-white font-semibold px-4 rounded' onClick={()=>editTodo(list.id)}>Edit</button></div>
